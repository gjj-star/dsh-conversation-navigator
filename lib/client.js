	...
	factory: (require) => {
		...
		function SwitchTurnsIcon() {
			return React.createElement("svg", {
				...
				React.createElement("path", { d: "M2.5 3.5h7" }),
				React.createElement("path", { d: "M7 1.5 9.5 3.5 7 5.5" }),
				React.createElement("path", { d: "M11.5 10.5h-7" }),
				React.createElement("path", { d: "M7 8.5 4.5 10.5 7 12.5" }),
			);
		}
