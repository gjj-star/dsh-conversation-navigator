...
> 自动生成于 2026-09-25 08:53Z · 数据源 npm downloads + GitHub traffic
> 图表：[traffic-trend.svg](./traffic-trend.svg) · 原始归档：[traffic-archive.json](./traffic-archive.json)

## 汇总（2026-08-17 → 2026-09-25）

| 指标 | 累计 | 最近 7 天日均 | 峰值日 |
| --- | --- | --- | --- |
| npm 下载 | 6,335 | 25 | 2026-08-17 |
| GitHub 独立访客 | 575 | 5 | 2026-08-28 |
| GitHub 独立克隆者 | 388 | 8 | 2026-08-17 |
| Stars | 23 | — | — |
| Forks | 1 | — | — |

最近发版：**0.2.10** @ 2026-09-24（1 天前）
