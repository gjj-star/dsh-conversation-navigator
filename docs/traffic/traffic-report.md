...
> 自动生成于 2026-09-19 08:07Z · 数据源 npm downloads + GitHub traffic
> 图表：[traffic-trend.svg](./traffic-trend.svg) · 原始归档：[traffic-archive.json](./traffic-archive.json)

## 汇总（2026-08-17 → 2026-09-19）

| 指标 | 累计 | 最近 7 天日均 | 峰值日 |
| --- | --- | --- | --- |
| npm 下载 | 6,118 | 46 | 2026-08-17 |
| GitHub 独立访客 | 540 | 12 | 2026-08-28 |
| GitHub 独立克隆者 | 335 | 8 | 2026-08-17 |
| Stars | 23 | — | — |
| Forks | 1 | — | — |

最近发版：**0.2.9** @ 2026-09-16（3 天前）
