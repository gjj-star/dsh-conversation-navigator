...
> 自动生成于 2026-09-18 08:19Z · 数据源 npm downloads + GitHub traffic
> 图表：[traffic-trend.svg](./traffic-trend.svg) · 原始归档：[traffic-archive.json](./traffic-archive.json)

## 汇总（2026-08-17 → 2026-09-18）

| 指标 | 累计 | 最近 7 天日均 | 峰值日 |
| --- | --- | --- | --- |
| npm 下载 | 6,118 | 55 | 2026-08-17 |
| GitHub 独立访客 | 512 | 9 | 2026-08-28 |
| GitHub 独立克隆者 | 313 | 6 | 2026-08-17 |
| Stars | 23 | — | — |
| Forks | 1 | — | — |

最近发版：**0.2.9** @ 2026-09-16（2 天前）
